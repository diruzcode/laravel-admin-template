            ...
            @foreach ($items as $index => $item)
              <tr>
                ...
                <td class="d-flex justify-content-center">
                  <a href="{{ route('dashboard::permissions.edit', ['role' => $item->id, 'page' => $page]) }}" class="btn btn-info btn-circle btn-sm" title="Editar" style="margin:1px">
                    <span class="icon">
                      <i class="fas fa-pen-alt"></i>
                    </span>
                  </a>
                  <a href="{{ route('dashboard::permissions.edit', ['role' => $item->id, 'page' => $page]) }}" class="btn btn-danger btn-circle btn-sm" title="Eliminar" style="margin:1px">
                    <span class="icon">
